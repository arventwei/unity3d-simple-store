...
public class StoreUnityPlayerProxyActivity extends Activity
{
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		String classNames[] = { "sisso.store.StoreUnityPlayerActivity", "sisso.store.StoreUnityPlayerNativeActivity" };
